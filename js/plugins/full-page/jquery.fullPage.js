...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        /**
        * Turns full-page.js to normal scrolling mode when the viewport `width` or `height`
        ...
        */
        function displayWarnings(){
            ...
            if(options.scrollOverflow && !options.scrollOverflowHandler){
                ...
                showError('error', 'The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before full-page.js.');
            }
        ...
        */
        function showError(type, text){
            console && console[type] && console[type]('full-page: ' + text);
        }
